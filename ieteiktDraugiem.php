...
$display = get_post_meta($post_id, 'ieteikt_draugiem', true);
$override = get_option('ieteikt-draugiem');
if($override == 1 && $display == 0) $display = 0;
...
function ieteikt_post_save($post_id)
{
	...
	add_post_meta($post_id, 'ieteikt_draugiem', $checked);
}
...
if(is_admin())
{
	...
	?>
		...
		<label for="ieteikt_global">Rādīt"Ieteikt Draugiem" visur, kur neesi atzīmējis "rādīt ieteikt pogu" ?</label>
		<br /><br />
